...
<html>
    ...
    <script type="text/javascript">
      $(document).ready(function(){
        ...
        /*function rotate($obj, deg){
          $obj.css({
              "-webkit-transform": "rotate("+ deg +"deg)",S
  ...
  <body>
    <div class="pep" id="1"></div>
    <div class="droppable tr" id="drop1"></div>
    <div class="droppable br" id="drop2"></div>
    <div class="droppable bl" id="drop3"></div>
    <div class="droppable tl" id="drop4"></div>
  </body>
