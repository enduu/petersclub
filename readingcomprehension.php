...
<body class="purpleb2">
    ...
    <div class="swiper-container advanced">
        ...
        <div class="swiper-wrapper economy">
            <!-- Slides -->
             <?php $count = 118;  //!change the number of slides!

                    for ($i = 0; $i < $count; $i++) {
                        echo '<div id="c';
                        echo $i+1;
                        echo '" class="swiper-slide" style="background-image: url(\'img/rc/rc (';
                        echo $i+1;
                        echo ').jpg\');">';
                        ...
                        echo  '      <div class="line">';
                        echo  '          <h2>Sight words</h2> <span class="pron">Page: ';
                        echo $i+1;
                        echo '/ ';
                        echo $count;
                        echo '</span>';
...
<script>
  $('div[id^="download"]').on('click', function () {
    ...
    const imageUrl = `img/rc/rc (${num}).jpg`;
