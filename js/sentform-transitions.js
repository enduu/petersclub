...
$('.key').one('click', function (e) { 
    ...
    $('.optiontext:nth-child(1)').css('visibility', 'visible');
    $('.optiontext:nth-child(1)').addClass('animate__animated animate__fadeInUp');
    setTimeout(() => {
        $('.optiontext:nth-child(2)').css('visibility', 'visible');
        $('.optiontext:nth-child(2)').addClass('animate__animated animate__fadeInUp');
    }, 500);
    setTimeout(() => {
        $('.optiontext:nth-child(3)').css('visibility', 'visible');
        $('.optiontext:nth-child(3)').addClass('animate__animated animate__fadeInUp');
            setTimeout(() => {
                $('.optiontext').removeClass('animate__animated animate__fadeInUp');
                $('.plays').removeClass('animate__animated animate__heartBeat animate__repeat-2');
                $('.firstt').addClass('first');
            }, 500);
    }, 1000);
});
